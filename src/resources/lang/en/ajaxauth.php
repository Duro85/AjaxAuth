...
return [
    "invalid_guard"            => "Can't find the guard named :GUARD",
    "invalid_data"             => "Please check the provided data, they ar invalid or incomplete.",
    "login_success"            => "User logged in.",
    "bad_configuration"        => "Please check your configuration.",
